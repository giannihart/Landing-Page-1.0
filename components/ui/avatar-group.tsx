...
export const AvatarGroup = ({ avatars, maxVisible = 5, size = 56, overlap = 14 }: AvatarGroupProps) => {
      ...
      <div className="flex -space-x-4">
        {visibleAvatars.map((avatar, idx) => {
          ...
          return (
            <div
              key={idx}
              className="border-2 border-background rounded-full bg-background transition-all duration-300 relative"
              style={{
                width: size,
                height: size,
